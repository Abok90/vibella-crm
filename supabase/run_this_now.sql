...
-- Fixes: "Could not find function approve_user"
-- =====================================================

-- 1. Add approval fields to profiles (safe — IF NOT EXISTS)
...
-- 5. ✅ THE MISSING FUNCTION — approve_user
DROP FUNCTION IF EXISTS approve_user(UUID, UUID, JSONB);
...
-- 7. Ensure existing profiles have permissions
...
-- 8. Grant existing approved users full access
...
-- ✅ DONE! Now approve_user function exists and signup trigger works.
